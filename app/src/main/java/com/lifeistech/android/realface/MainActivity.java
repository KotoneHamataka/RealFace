...
public class MainActivity extends AppCompatActivity {
    ...
    public void detectFace(View view) {
        ...
        float[] smile_result = new float[5];
        smile_result = overlay.getSmilePoints();

        Toast.makeText(this, smile_result[0] + "点!!", Toast.LENGTH_LONG).show();
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.lifeistech.android.realface/http/host/path")
        );
